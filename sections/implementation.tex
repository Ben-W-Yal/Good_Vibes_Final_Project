...
\begin{figure}[!htbp]
  ...
  \end{tikzpicture}
  \caption{High-level architecture (simplified). Adapters normalize heterogeneous providers; generative routes call Gemini with prompts built from stored context and (for PDB) search tools when enabled.}
